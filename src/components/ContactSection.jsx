...
const ContactSection = () => {
  ...
  return (
    <div id='contact' className='h-screen max-lg:h-[50vh] w-full px-20 max-xl:px-0 max-md:mb-20'>
        <div className='h-[6rem] text-[4rem] max-sm:text-[3rem] max-sm:text-center md:px-20 xl:px-0'>{t("Iletisim")}</div>
