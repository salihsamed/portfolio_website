    ...
    <div className='h-screen w-full px-20 max-lg:px-0 flex flex-col gap-56 max-lg:gap-0'>
        ...
        <div className='flex gap-20 max-lg:flex-col max-lg:gap-0'>
            ...
            <div className='flex flex-col'>
                <p className='lg:leading-10 max-sm:text-xs max-lg:text-xl text-center px-1'>{t("About_p1")}<br/>{t("About_p2")}<br/>{t("About_p3")}<a href="https://www.2adam.com.tr/" target='_blank' className='underline text-orange-500 hover:text-orange-300 visited:text-orange-500'>{t("About_p4")}</a>{t("About_p5")}<br/>{t("About_p6")}</p>
